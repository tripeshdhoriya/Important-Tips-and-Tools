...
$curlArg = '-X','POST','-H','accept: application/json','-H','Content-Type: application/json','--data','{ \"text\": \"Parker YellowHammer-Server is down! Please check it.\"}',$baseURI
